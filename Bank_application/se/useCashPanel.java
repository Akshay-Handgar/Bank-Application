...
class useCashPanel extends JPanel{
	...
	useCashPanel(){		
		...
		userName.setHorizontalAlignment(JLabel.CENTER); //라벨 중앙정렬
		userBalance.setHorizontalAlignment(JLabel.CENTER); //라벨 중앙정렬
	...
	static void setTable(){
		...
		//붙이는 순서 중요! table 붙이고 -> 스크롤 생성 -> 스크롤 붙이기
