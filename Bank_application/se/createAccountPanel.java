...
class createAccountPanel extends JPanel{ 
	...
	JLabel resisterNumberLabel = new JLabel("주민번호"); 
	...
	JLabel checkedPasswdLabel = new JLabel("비밀번호재입력"); 
	...
	static JButton reCreate = new JButton("비밀번호 확인"); 
	
	JPanel hobbyPanel = new JPanel(); //관심 	
